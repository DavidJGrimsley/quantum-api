...
_ARTIFACTS = {
    "/v1/optimization/qaoa": (
        ...
        _ROOT / "docs" / "notebooks" / "phase5" / "optimization-qaoa.ipynb",
    ),
    "/v1/optimization/vqe": (
        _ROOT / "docs" / "domains" / "optimization-vqe.md",
        _ROOT / "docs" / "notebooks" / "phase5" / "optimization-vqe.ipynb",
    ),
    "/v1/experiments/state_tomography": (
        _ROOT / "docs" / "domains" / "experiments-state-tomography.md",
        _ROOT / "docs" / "notebooks" / "phase5" / "experiments-state-tomography.ipynb",
    ),
    "/v1/experiments/randomized_benchmarking": (
        _ROOT / "docs" / "domains" / "experiments-randomized-benchmarking.md",
        _ROOT / "docs" / "notebooks" / "phase5" / "experiments-randomized-benchmarking.ipynb",
    ),
    "/v1/finance/portfolio_optimization": (
        _ROOT / "docs" / "domains" / "finance-portfolio-optimization.md",
        _ROOT / "docs" / "notebooks" / "phase5" / "finance-portfolio-optimization.ipynb",
    ),
    "/v1/ml/kernel_classifier": (
        _ROOT / "docs" / "domains" / "ml-kernel-classifier.md",
        _ROOT / "docs" / "notebooks" / "phase5" / "ml-kernel-classifier.ipynb",
    ),
    "/v1/nature/ground_state_energy": (
        _ROOT / "docs" / "domains" / "nature-ground-state-energy.md",
        _ROOT / "docs" / "notebooks" / "phase5" / "nature-ground-state-energy.ipynb",
    ),
}


def test_phase5_markdown_guides_reference_current_v1_paths():
...
def test_phase5_notebooks_parse_and_reference_current_v1_paths():
